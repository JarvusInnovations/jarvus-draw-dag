...
*/
Ext.define('Jarvus.draw.layout.TopDown', {
    alias: 'daglayout.topdown',
    ...
    fn: function(dag) {
        ...
        res = dagfn.topDownLayerByLayerSweep(dagAndLayers.dag, dagAndLayers.layers, dagfn.two_layer_adjacent_exchange);
